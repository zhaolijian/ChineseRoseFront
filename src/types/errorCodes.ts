...
export const ERR_TOKEN_MALFORMED = ErrorCode.ERR_TOKEN_MALFORMED
export const ERR_REFRESH_REQUIRED = ErrorCode.ERR_REFRESH_REQUIRED
...
export const ERR_REQUEST_TIMEOUT = ErrorCode.ERR_REQUEST_TIMEOUT
export const ERR_SERVICE_TIMEOUT = ErrorCode.ERR_SERVICE_TIMEOUT
export const ERR_EXTERNAL_TIMEOUT = ErrorCode.ERR_EXTERNAL_TIMEOUT
export const ERR_SERVICE_UNAVAILABLE = ErrorCode.ERR_SERVICE_UNAVAILABLE
export const ERR_EXTERNAL_UNAVAIL = ErrorCode.ERR_EXTERNAL_UNAVAIL
